  ...
  $booksPerPage = 20; // Number of books to show per page
  ...
  elseif (!empty($selectedCollection)) {
      ...
      // Default: show all books with a book_star rating
      $query .= " WHERE book_star IS NOT NULL AND book_star != ''";
      $pageTitle = "My 1,000 Favorite Books";
  }

  // Add ORDER BY clause for sorting
  if ($sortBy === 'default') {
      // For default, order by vote_up count (descending)
      $query .= " ORDER BY CAST(vote_up AS SIGNED) DESC";
  }
  ...
  $totalBooksResult = $conn->query("SELECT COUNT(*) AS total FROM books" . 
                                  substr($countQuery, strpos($countQuery, " WHERE")));
  $totalBooks = $totalBooksResult->fetch_assoc()['total'];
  $totalPages = ceil($totalBooks / $booksPerPage);

  // Function to generate sort URL
  function getSortUrl($field) {
      global $sortBy, $sortOrder, $searchTerm, $selectedGenre, $selectedCollection, $page;
...
<nav class="navbar navbar-expand-lg navbar-light">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <a class="nav-link" href="https://kylebenzle.com/faq.php">Login/Post</a>

            <!-- Blog Home Right-Aligned -->
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                  
                    <a class="nav-link" href="https://kylebenzle.com">Home </a>
                </li>
            </ul>
        </div>
    </div>
          ...
          <div class="container">
              <div class="row align-items-center">
                  <div class="col-md-6 mb-3 mb-md-0">
                      ...
                      <p class="lead">Reviewed by me and sorted by popularity. Helping everyone find the best books!</p>
                  </div>
          ...
          <div class="d-flex justify-content-between align-items-center mb-4">
              <h2 class="h4 mb-0">
                  <?php 
                    ...
                    echo "Showing $start-$end of $totalBooks books";
                  ?>
                  <?php if ($totalPages > 1): ?>
                  ...
                  <nav aria-label="Book pagination" class="mt-4">
                      <ul class="pagination justify-content-center">
                          ...
                          <li class="page-item <?php echo ($page <= 1) ? 'disabled' : ''; ?>">
                              <a class="page-link" href="<?php echo getPaginationUrl(max(1, $page - 1)); ?>" aria-label="Previous">
                          ...
                          <?php if ($page < $totalPages - 2): ?>
                              ...
                              <?php endif; ?>
                              <li class="page-item">
                                  <a class="page-link" href="<?php echo getPaginationUrl($totalPages); ?>"><?php echo $totalPages; ?></a>
                              </li>
                          <?php endif; ?>
                          
                          <!-- Next Button -->
                          <li class="page-item <?php echo ($page >= $totalPages) ? 'disabled' : ''; ?>">
                              <a class="page-link" href="<?php echo getPaginationUrl(min($totalPages, $page + 1)); ?>" aria-label="Next">
  ...
  Find, review, discuss, vote on and download the best audiobooks online.</p>
                  ...
                  <div class="col-lg-3 offset-lg-1">
                      ...
                      <ul class="list-unstyled">
                          ...
                          <li class="mb-2"><a href="faq.html">Use this site</a></li>
                          <li class="mb-2"><a href="https://kylebenzle.com">Home</a></li>
